...
<head>
    ...
    <script language="javascript"
            src="http://js.mafengwo.net/js/cv/js+jquery-1.8.1.min:js+global+json2:js+M+Module:js+M+M:js+M+Log:js+m.statistics^ZFw^1489387530.js"
        ...
        <div class="side_bar flt1">
            ...
            <div class="MAvatar">
                ...
                <div class="MAvaMore clearfix">
                    <div class="MAvaNums">
                        <strong><a href="#" target="_blank">4</a></strong>
                        <p>喜欢</p>
                    </div>
                    <div class="MAvaNums">
                        <strong><a></a></strong>
        ...
        <div class="content flt2">
            <div class="common_block main_links">
                <ul class="clearfix">
                    ...
                    <li><a href="/wenda/" target="_blank"><i class="add_footprint"></i><span>历史足迹</span></a></li>
                    <li><a href="/path/" target="_blank"><i class="ask_expert"></i><span>我感兴趣</span></a></li>
            ...
            <div class="common_block my_notes">
                ...
                <ul>
                    <li>
                        <dl>
                            <dt>
                                <a href="/i/6847007.html"><img src="${pageContext.request.contextPath}/images/my/default.jpg" height="400" width="680" alt="封面"></a>
                            ...
                            <dd>
                                <div class="note_title clearfix">
                                    ...
                                    <div class="note_info">
                                        <h3><a href="/i/6847007.html" title="个人游记">个人游记</a></h3>
                                        <div class="note_more">
                                            <span class="time">2017-04-07 13:53:02</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="note_word">
