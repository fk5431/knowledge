...
<head>
    <title>图集</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/index6.css"/>
    <link type="text/css" rel="Stylesheet" href="${pageContext.request.contextPath}/css/imageflow.css" />
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/jquery.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/imageflow.js"></script>
</head>
<body>
<div class="header">
...
<div class="container" id="app" class="page-news/photo" >
    <div class="gallery-header">
      <span class="gallery-title" title="${title}">
        ${title}
    </span>
    </div>
    <div class="gallery-container clearfix" >
        <div id="LoopDiv">
            ...
            <div id="starsIF" class="imageflow">
                <%
                    String[] imgs = (String[])request.getAttribute("images");
                    for(int i=0;i<imgs.length;i++){
                %>
                <img src="<%=imgs[i]%>" longdesc="#" width="280" height="300" alt="Picture" />
                <%}%>
            </div>
        </div>
    </div>
