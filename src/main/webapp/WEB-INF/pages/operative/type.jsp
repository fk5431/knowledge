            ...
            <table class="table table-hover text-center">
                ...
                <tr>
                    <form action="${pageContext.request.contextPath}/operative/updatetype" method="get" id="user<%=i%>">
                        <td><%=typeBeans.get(i).getId()%>
                        </td>
                        <td><%=typeBeans.get(i).getTypename()%>
                        </td>
                        <td><input type="text" name="typename"/><input type="text" name="id" hidden
                                                                       value="<%=typeBeans.get(i).getId()%>"/></td>
                        <td>
                        ...
                        <td>
                            <div class="button-group"><a class="button border-red"
                                                         href="${pageContext.request.contextPath}/operative/deltype?id=<%=typeBeans.get(i).getId()%>"><span
                ...
                <tr>
                    <td colspan="8">
                        <div class="pagelist">
                            ...
                            <%} else {%>
                            <a href="${pageContext.request.contextPath}/operative/type?page=<%=i%>"><%=i%>
                            </a>
                            <%
                                    }
                                }
