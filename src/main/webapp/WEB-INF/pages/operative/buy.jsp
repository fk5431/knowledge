...
<div class="admin">
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            ...
            %>
            <tr>
                <td><%=recordBeans.get(i).getId()%></td>
                <td><%=recordBeans.get(i).getMovieid()%></td>
                <td><%=recordBeans.get(i).getMoviename()%></td>
                <td><%=recordBeans.get(i).getName()%></td>
                <td><%=recordBeans.get(i).getEmail()%></td>
                <td><%=recordBeans.get(i).getWechat()%></td>
                <td><%=recordBeans.get(i).getMob()%></td>
                <td><%=recordBeans.get(i).getOther()%></td>
                <td><%=recordBeans.get(i).getUserid()%></td>
                <td>
                    <div class="button-group">
                        <a class="button border-red" href="${pageContext.request.contextPath}/operative/delrecord?id=<%=recordBeans.get(i).getId()%>"  ><span class="icon-trash-o"></span> 删除</a>
                    </div>
                </td>
            </tr>
            <%}%>
