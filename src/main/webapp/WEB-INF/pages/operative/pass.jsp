...
<div class="admin">
    ...
    <div class="panel admin-panel margin-top" id="add">
        <div class="panel-head">
            <strong>
                <span class="icon-pencil-square-o"></span> 演员信息
            </strong>
        </div>
        <div class="body-content">
            <table class="table table-hover text-center">
                ...
                %>
                <tr>
                    <td><%=performerBeans.get(i).getId()%>
                    </td>
                    <td><img src="<%=performerBeans.get(i).getImage()%>" width="120" height="50"/></td>
                    <td><%=performerBeans.get(i).getName()%>
                    </td>
                    <td><%=performerBeans.get(i).getOthername()%>
                    </td>
                    <td><%=performerBeans.get(i).getIntroduce()%>
                    </td>
                    <td>
                ...
                <tr>
                    <td colspan="8">
                        <div class="pagelist">
                            ...
                            <%} else {%>
                            <a href="${pageContext.request.contextPath}/operative/pass?page1=<%=i%>"><%=i%>
                            </a>
                            <%
                                    }
                                }
