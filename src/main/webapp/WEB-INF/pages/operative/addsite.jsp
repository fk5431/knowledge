...
<div class="admin">
    <div class="panel admin-panel">
        ...
        <div class="body-content">
            <form method="post" class="form-x" action="${pageContext.request.contextPath}/operative/addsiteinfo"
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input" name="site" value=""/>
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="label">
                        <label>影院状态（0不可用）：</label>
                    </div>
                    <div class="field">
