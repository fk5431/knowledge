...
<div class="admin" style="position: static; ">
    <div class="panel admin-panel">
        <div class="panel-head"><strong><span class="icon-pencil-square-o"></span> 单页信息</strong></div>
        <div class="body-content">
            <form method="post" class="form-x" action="${pageContext.request.contextPath}/operative/useraddart"
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <select name="type">
                            ...
                            %>
                            <option value ="<%=type.get(i).getId()%>"><%=type.get(i).getType()%></option>
                            <%}%>
                        </select>
                        <div class="tips"></div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input" name="line" value=""/>
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
