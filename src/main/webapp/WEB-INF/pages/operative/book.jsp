            ...
            <form method="post" class="form-x" action="${pageContext.request.contextPath}/operative/addmovie"
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        <select name="type">
                            ...
                            %>
                            <option value="<%=type.get(i).getId()%>"><%=type.get(i).getTypename()%>
                            </option>
                            <%}%>
                        </select>
                        <div class="tips"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="field">
                        ...
                        %>
                        <label><input name="performer" type="checkbox"
                                      value="<%=performerBeans.get(i).getId()%>"/><%=performerBeans.get(i).getName()%>
                        </label>
                        <%}%>
                        <div class="tips"></div>
                    </div>
