...
<div class="admin">
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            ...
            <%
                List<AuditBean> travel = (List)request.getAttribute("travel");
            ...
            <tr>
                ...
                <td>
                    <div class="button-group">
                        <a type="button" class="button border-main" href="${pageContext.request.contextPath}/articleuser?id=<%=travel.get(i).getId()%>" target="_blank"><span class="icon-edit"></span>查看</a>
                        <a type="button" class="button border-main" href="${pageContext.request.contextPath}/operative/agree?id=<%=travel.get(i).getId()%>"><span class="icon-edit"></span>同意</a>
                        <a class="button border-red" href="${pageContext.request.contextPath}/operative/articleuser?id=<%=travel.get(i).getId()%>"  ><span class="icon-trash-o"></span> 删除</a>
                    </div>
                </td>
            </tr>
            <%}%>
