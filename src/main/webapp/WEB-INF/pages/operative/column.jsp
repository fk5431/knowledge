...
<div class="admin">
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            ...
            %>
            <tr>
                <td><%=movieBeans.get(i).getId()%>
                </td>
                <td><%=movieBeans.get(i).getTitle()%>
                </td>
                <td><%=movieBeans.get(i).getShowtime()%>
                </td>
                <td>
                    <div class="button-group">
                        <a type="button" class="button border-main"
                           href="${pageContext.request.contextPath}/film?id=<%=movieBeans.get(i).getId()%>"
                           target="_blank"><span class="icon-edit"></span>查看</a>
                        <a class="button border-red"
                           href="${pageContext.request.contextPath}/operative/delfilm?id=<%=movieBeans.get(i).getId()%>"><span
            ...
            <tr>
                <td colspan="8">
                    <div class="pagelist">
                        ...
                        <%} else {%>
                        <a href="${pageContext.request.contextPath}/operative/column?page=<%=i%>"><%=i%>
                        </a>
                        <%
                                }
                            }
