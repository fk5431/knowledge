         ...
         <div id="searchformbox">
             <div id="searchformtabsbox">
                 <ul id="searchformtabs" aria-label="Search forms" role="navigation"
                     ...
                     <li>
                         <h1 class="link" >
                             <a id="quickSearchTab" href="#" class="tablink here" title="Quick Search  (currently selected form)">高级搜索</a>
                         </h1>
                     </li>
                 </ul>
             </div>
             ...
             <div id="searchcontents" class="shadowbox" role="search" aria-label="Quick Search">
                 <div >
                     <form method="POST" name="quicksearch" action="advancedsearch" id="searchform" target="_top">
                         <div id="searchcomponentfullwrap" class="searchcomponentfullwrap" style="padding-bottom: 0px;">
                             <div id="searchfields">
                                 ...
                                 <div class="searchforline">
                                     ...
                                     <span style="position: relative; display: inline;" class="twitter-typeahead">
                                         <input style="position: absolute; border-color: transparent; box-shadow: none; background: rgb(255, 255, 255) none repeat scroll 0% 0%;" class="tt-hint" autocomplete="off" spellcheck="off" disabled="" type="text">
                                         <input dir="auto" style="position: relative; vertical-align: top; background-color: transparent;" spellcheck="false" autocomplete="off" name="searchWord1" id="srchWrd1" title="Search Text Box 1" class="searchword tt-query" value="" type="text">
                                         ...
                                         <span style="position: absolute; left: 1px; z-index: 999; display: none;" class="tt-dropdown-menu"></span>
                                     </span>
                                     <span>in</span>
                                     <label class="hidden" for="sect1">Search Within 1</label>
                                     <select size="1" name="section1" id="sect1" title="Search Within Dropdown 1" class="section">
                                 ...
                                 <div class="searchforline">
                                     ...
                                     <span style="position: relative; display: inline;" class="twitter-typeahead">
                                         <input style="position: absolute; border-color: transparent; box-shadow: none; background: rgb(255, 255, 255) none repeat scroll 0% 0%;" class="tt-hint" autocomplete="off" spellcheck="off" disabled="" type="text">
                                         <input dir="auto" style="position: relative; vertical-align: top; background-color: transparent;" spellcheck="false" autocomplete="off" name="searchWord2" id="srchWrd2" title="Search Text Box 2" class="searchword tt-query" value="" type="text">
                                         <span style="position: absolute; left: -9999px; visibility: hidden; white-space: nowrap; font-family: MS Shell Dlg \32 ; font-size: 13.3333px; font-style: normal; font-variant: normal; font-weight: 400; word-spacing: 0px; letter-spacing: 0px; text-indent: 0px; text-rendering: optimizelegibility; text-transform: none;"></span>
                                         <span style="position: absolute; left: 1px; z-index: 999; display: none;" class="tt-dropdown-menu"></span>
                                     </span>
                                     <span>in</span>
                                     <label class="hidden" for="sect2">Search Within 2</label>
                                     <select size="1" name="section2" id="sect2" title="Search Within Dropdown 2" class="section">
                                         <option value="title">标题</option>
                                         <option value="user">上传者</option>
                                         <option value="tags">标签</option>
                                         <option value="abstracString">摘要</option>
                                 ...
                                 <div class="searchforconnector">
                                     ...
                                     <select size="1" name="boolean2" id="cbnt2" title="boolean operator for combining textbox 2 and textbox 3" class="boolean">
                                         <option value="AND">AND</option>
                                         <option value="OR">OR</option>
                                         <option value="NOT">NOT</option>
                                     </select>
                                 ...
                                 <div class="searchforline">
                                     ...
                                     <span style="position: relative; display: inline;" class="twitter-typeahead">
                                         <input style="position: absolute; border-color: transparent; box-shadow: none; background: rgb(255, 255, 255) none repeat scroll 0% 0%;" class="tt-hint" autocomplete="off" spellcheck="off" disabled="" type="text">
                                         <input dir="auto" style="position: relative; vertical-align: top; background-color: transparent;" spellcheck="false" autocomplete="off" name="searchWord3" id="srchWrd3" title="Search Text Box 3" class="searchword tt-query" value="" type="text">
                                         <span style="position: absolute; left: -9999px; visibility: hidden; white-space: nowrap; font-family: MS Shell Dlg \32 ; font-size: 13.3333px; font-style: normal; font-variant: normal; font-weight: 400; word-spacing: 0px; letter-spacing: 0px; text-indent: 0px; text-rendering: optimizelegibility; text-transform: none;"></span>
                                         <span style="position: absolute; left: 1px; z-index: 999; display: none;" class="tt-dropdown-menu"></span>
                                     </span>
                                     <span> in </span>
                                     <label class="hidden" for="sect3">Search Within 3</label>
                                     <select size="1" name="section3" id="sect3" title="Search Within Dropdown 3" class="section">
                                         <option value="title">标题</option>
                                         <option value="user">上传者</option>
                                         <option value="tags">标签</option>
                                         <option value="abstracString">摘要</option>
                             ...
                             <div id="addsearcherror" class="searchforline" style="display: none; padding-left: 400px;">
                                 <img src="1x1_transparent.png" class="sprite sprite-warning_red" alt="Error message">
                                 <b> 最多可以筛选10个条件</b>
                             </div>
                             ...
                             <ul id="search_toolbar" class="horizlist">
                                 ...
                                 <li id="addsearchfield_tool" class="text">
                                     <span id="addsearchllinkgray" title="Add search field" class="greytext" style="display: none;">
                                         <img src="${pageContext.request.contextPath}/images/1x1_transparent.png" class="addsearchimg sprite sprite-addsearchfield" alt="">
                                         增加条件
                                     </span>
                         ...
                         <div id="advancedOptions">
                             <h2 class="advancedOptionslabel">
                                 <span id="advancedOptionstoggle">高级条件&nbsp;
                                     <a class="historyplus" id="advancedOptionstoggleAnchor" href="#" title="Show adavanced options">
                                         <img src="${pageContext.request.contextPath}/images/1x1_transparent.png" class="sprite sprite-login_expand" alt="">
                                     </a>
                                 </span>
                             </h2>
                             <div id="advancedOptionshidden" style="float: none; clear: both; display: none;">
                                 ...
                                 <div class="searchcomponentshortwrap">
                                     <div id="limittowrap" style="width: 380px; float: left;">
                                         ...
                                         <div class="searchlimitbybox">
                                             <fieldset>
                                                 <ul>
                                                     <li>
                                                         ...
                                                         <input checked="checked" id="yearrangechx" value="yearrange" type="radio">
                                                         <label class="hidden" for="startyrrange">Start Year</label>
                                                         <select name="startYear" style="width: 5em;" id="" title="Choose a date range">
                                                         ...
                                                         <div class="searchcomponentlabel" style="float: none; margin: 0px 15px; display: inline;">
                                                             TO
                                                         </div>
                                                         <label class="hidden" for="endyearrange">End
                                                             Year
                                                         </label>
                                                         <select name="endYear" style="width: 5em;" id="endyearrange" title="Choose a date range">
                                                             <option value="1969">1969</option>
                                                             <option value="1970">1970</option>
                                                             <option value="1971">1971</option>
                                                             <option value="1972">1972</option>
                                             ...
                                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             <select name="ftype" style="width: 5em;" id="startyrrange" title="Choose a date range">
                                 ...
                                 <div id="buttonsbottom" class="searchcomponentshortwrap" style="position: relative; margin-top: -30px; float: none; z-index: 1;">
                                     <div style="float: right; margin-bottom: 7px;">
                                         <input disabled="disabled" class="button searchbtn" value="保存并搜索" title="Submit Search" type="button" onclick="save()">&nbsp;
                                         <input disabled="disabled" class="button searchbtn" value="搜索" title="Submit Search" type="submit">&nbsp;
                                         <input class="formreset" value="重置" title="Reset search" type="reset">&nbsp;
                                         <div class="clear"></div>
                                     </div>
                                     <div class="clear"></div>
 ...
 <div class="addsearchfieldcopy" style="display: none;">
     ...
     <div class="searchforline" id="addsearchforline">
         ...
         <a class="removesearchlink" title="Remove this search field.">
             <img src="${pageContext.request.contextPath}/images/1x1_transparent.png" alt="" class="sprite sprite-Delete">
         </a>
     </div>
 </div>
 <script type="text/javascript">
