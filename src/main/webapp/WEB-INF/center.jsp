   ...
   box-shadow:0px 0px 10px #909090;">
        <div class="fzq">
            ...
            <ul class="navfzq tab_title">
                ...
                <li id="one1" class="off">
                    <div class="tab_title">
                        <a href="javascript:;" class="cur" style="line-height:3;">常用文档</a>
                    </div>
                </li>
                <li id="one2">
                    <div class="tab_title">
                ...
                <li id="one3">
                    <div class="tab_title">
                        <a href="center2" class="cur" style="line-height:3;">搜索结果</a>
                    </div>
                </li>
                <li id="one4">
                    <div class="tab_title">
        ...
        <div id="con_one_1">
            <ul class="list02" id="feed_list">
                <c:forEach var="page" items="${page_center_cdocument.userfile }">
                    <li class="clearfix">
                        <div class="ahover clearfix">
                            <a href="search_ktypeid?ktypeid=${page.ktypeid }"
                               class="firstdiv firstc13"> <i class="fa fa-cubes"></i> <em>${page.ktypeid }</em>
                            </a> <span class="twodiv"> <a contentId="9811"
                                                          href="showfile?id=${page.fid }" class="title" target="_blank"
                                                          title="${page.title }">${page.title } <i
                                class="iconfont icon-article" title="文章"></i>
								</a> <br />
									<div
									...
									</span> <span class="inforright">
											${page.uploadtime}&nbsp;&nbsp; <em class="r">${page.uname }&nbsp;&nbsp;</em>
											<a>${page.ftypeid }</a>
									</span>
								</span>
								</span>
                ...
                <div class="csdn-pagination hide-set page1">
						<span class="page-nav"> <b>共<i>${page_center_cdocument.totalNum }条第${page_center_cdocument.pageNO }页</i></b>
							<a href="${pageContext.request.contextPath }/paging_center?n=1"
                               data-page='1' class="btn btn-xs btn-default">首页</a> <a
                                    href="${pageContext.request.contextPath }/paging_center?n=${page_center_cdocument.pageNO-1 }"
                                    data-page='1' class="btn btn-xs btn-default">&lt</a> <c:forEach
                                    var="t" begin="${page_center_cdocument.startPage }"
                                    end="${page_center_cdocument.endPage }">
                                <c:if test="${t == page_center_cdocument.pageNO }">
									<a
                                            href="${pageContext.request.contextPath }/paging_center?n=${t}"
                                ...
                                <c:if test="${t != page_center_cdocument.pageNO }">
                                    ...
                                    href="${pageContext.request.contextPath }/paging_center?n=${page_center_cdocument.pageNO+1 }"
                                    data-page='1' class="btn btn-xs btn-default">></a> <a
                                    href="${pageContext.request.contextPath }/paging_center?n=${page_center_cdocument.totalPage }"
                                    data-page="907" class="btn btn-xs btn-default">末页</a>
						</span>
                </div>
            </ul>
        </div>
