                    ...
                    <td id="KB_search_right" colspan="1" rowspan="1" class="cell"
                        ...
                        <div class="row-wrapper">
                            ...
                            <div class="csdn-pagination hide-set page1">
									...
									<a href="${pageContext.request.contextPath }/searchType?page=1&type=${type}" data-page="1"
                                       class="btn btn-xs btn-default">首页</a>
                                        <a href="${pageContext.request.contextPath }/searchType?page=<c:choose><c:when test="${pageNow == 1}">1</c:when><c:otherwise>${pageNow-1}</c:otherwise></c:choose>&type=${type}"
                                           data-page="1" class="btn btn-xs btn-default">&lt;</a>
								<c:forEach var="t" begin="1" end="${page }">
                                    <c:if test="${page <= 5 }">
                                        <c:if test="${t == pageNow }">
                                            <a href="${pageContext.request.contextPath }/searchType?page=${t}&type=${type}"
									...
									<a href="${pageContext.request.contextPath }/searchType?page=${pageNow+1 }&type=${type}"
                                       data-page="907" class="btn btn-xs btn-default">&gt;</a>
									<a href="${pageContext.request.contextPath }/searchType?page=${page }&type=${type}" data-page="907"
