...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="eng" lang="eng">
  ...
  <title>404</title>
   <link rel="stylesheet" media="screen" href="${pageContext.request.contextPath}/css/404/style.css" type="text/css" />
   ...
   <div class="controller">
    ...
    <!-- text area -->
    <!-- home page --> 
    <div class="copyrights">Collect from <a  >Website Template</a></div>
    <div class="homepage rotate">
    <a href="http://localhost:8080/knowledge">Back to homepage</a>
    </div> <!-- home page --> 
    </div> <!-- social-icons --> 
    <div class="social">
