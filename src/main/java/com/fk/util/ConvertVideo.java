...
/**
 * Created by FK on 2017/5/16.
 */


public class ConvertVideo {
    private static String mencoder_home = "D:\\transform\\mencoder.exe";
    private static String ffmpeg_home = "D:\\transform\\ffmpeg.exe";//ffmpeg.exe所放的路径
    ...
    public static String outputFile_home = "D:\\result\\";//转换后的flv文件所放的文件夹位置
    private String tempFile_home;//存放rm,rmvb等无法使用ffmpeg直接转换为flv文件先转成的avi文件

    public ConvertVideo(String tempFilePath){
