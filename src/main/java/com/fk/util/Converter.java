...
public class Converter {
    ...
    public Converter(String fileString) {
        ini(fileString);
    }
                ...
                if (environment == 1) {// windows环境处理
                    try {
                        ...
                        System.err.println("****swf转换成功，文件输出："
                                + swfFile.getPath() + "****");
                        File destFile = new File(first, second);
                        File f = new File(swfFile.getPath());
