...
public class PagingResourcesOfService extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		...
		String sq = (String) request.getSession().getAttribute("sql");
		int uid = (Integer) request.getSession().getAttribute("uid");
		String[] str = (String[]) request.getSession().getAttribute("str");
		int cou = (Integer) request.getSession().getAttribute("cou");
		page = dao.getSearchResources(sq, uid, str, cou, num, totalnum);
