							...
							<div class="row-wrapper">
								...
								<div id="KB_brand_facet"
									...
									<div class="KB_facetlist">
										...
										<div class="KB_facetlist_content">
											<ul>
												<li class="category" <c:if test="${m==11}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[0]}</span><a
													title="生物" href="search_resources?m=11">生物</a></li>
												<li class="category" <c:if test="${m==12}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[1]}</span><a
													title="资源" href="search_resources?m=12">资源</a></li>
												<li class="category" <c:if test="${m==13}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[2]}</span><a
													title="环境" href="search_resources?m=13">环境</a></li>
												<li class="category" <c:if test="${m==14}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[3]}</span><a
													title="现象" href="search_resources?m=14">现象</a></li>
												<li class="category" <c:if test="${m==15}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[4]}</span><a
													title="天文" href="search_resources?m=15">天文</a></li>
												<li class="category" <c:if test="${m==16}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[5]}</span><a
									...
									<div class="KB_facetlist collapsed">
										...
										<div class="KB_facetlist_content">
											<ul style="right: -17px;" tabindex="0" class="nano-content">
												<li class="category" <c:if test="${m==21}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[6]}</span><a
													title="语言"
													href="search_resources?m=21">语言</a></li>
												<li class="category" <c:if test="${m==22}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[7]}</span><a
													title="民族"
													href="search_resources?m=22">民族</a></li>
												<li class="category" <c:if test="${m==23}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[8]}</span><a
													title="宗教"
													href="search_resources?m=23">宗教</a></li>
												<li class="category" <c:if test="${m==24}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[9]}</span><a
													title="国家历史"
													href="search_resources?m=24">国家历史</a></li>
												<li class="category" <c:if test="${m==25}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[10]}</span><a
													title="文学"
													href="search_resources?m=25">文学</a></li>
												<li class="category" <c:if test="${m==26}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[11]}</span><a
													title="哲学"
								...
								<div id="w1airkp8ac"
									...
									<div class="KB_facetlist collapsed">
										...
										<div class="KB_facetlist_content">
											<ul style="right: -17px;" tabindex="0" class="nano-content">
												<li class="category" <c:if test="${m==31}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[12]}</span><a
													title="饮食" style="padding-left: 0px;"
													href="search_resources?m=31">饮食</a></li>
												<li class="category" <c:if test="${m==32}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[13]}</span><a
													title="健康" style="padding-left: 0px;"
													href="search_resources?m=32">健康</a></li>
												<li class="category" <c:if test="${m==33}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[14]}</span><a
													title="情感" style="padding-left: 0px;"
													href="search_resources?m=33">情感</a></li>
												<li class="category" <c:if test="${m==34}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[15]}</span><a
													title="教育" style="padding-left: 0px;"
													href="search_resources?m=34">教育</a></li>
												<li class="category" <c:if test="${m==35}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[16]}</span><a
													title="就业" style="padding-left: 0px;"
													href="search_resources?m=35">就业</a></li>
												<li class="category" <c:if test="${m==36}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[17]}</span><a
													title="居家"
								...
								<div id="w1airkp8ad"
									...
									<div class="KB_facetlist collapsed">
										...
										<div class="KB_facetlist_content">
											<ul>
												<li class="category" <c:if test="${m==41}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[18]}</span><a
													title="法律" style="padding-left: 0px;"
													href="search_resources?m=41">法律</a></li>
												<li class="category" <c:if test="${m==42}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[19]}</span><a
								...
								<div id="w1airkp8ae"
									...
									<div class="KB_facetlist collapsed">
										...
										<div class="KB_facetlist_content" id="w1airkp8ae_content">
											...
											<ul style="right: -17px;" tabindex="0" class="nano-content">
												<li class="category" <c:if test="${m==51}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[20]}</span><a
													title="心理学" style="padding-left: 0px;"
													href="search_resources?m=51">心理学</a></li>
												<li class="category" <c:if test="${m==52}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[21]}</span><a
													title="理" style="padding-left: 0px;"
													href="search_resources?m=52">数理科学和化学</a></li>
												<li class="category" <c:if test="${m==53}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[22]}</span><a
													title="天文学地球科学" style="padding-left: 0px;"
													href="search_resources?m=53">天文学地球科学</a></li>
												<li class="category" <c:if test="${m==54}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[23]}</span><a
													title="农业" style="padding-left: 0px;"
													href="search_resources?m=54">农业</a></li>
												<li class="category" <c:if test="${m==55}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[24]}</span><a
													title="工业技术" style="padding-left: 0px;"
													href="search_resources?m=55">工业技术</a></li>
												<li class="category" <c:if test="${m==56}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[25]}</span><a
													title="医学" style="padding-left: 0px;"
													href="search_resources?m=56">医学</a></li>
												<li class="category" <c:if test="${m==57}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[26]}</span><a
													title="计算机" style="padding-left: 0px;"
													href="search_resources?m=57">计算机</a></li>
												<li class="category" <c:if test="${m==58}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[27]}</span><a
								...
								<div id="w1airkp8af"
									...
									<div class="KB_facetlist collapsed">
										...
										<div class="KB_facetlist_content">
											<ul style="right: -17px;" tabindex="0" class="nano-content">
												<li class="category" <c:if test="${m==61}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[28]}</span><a
													title="绘画" style="padding-left: 0px;"
													href="search_resources?m=61">绘画</a></li>
												<li class="category" <c:if test="${m==62}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[29]}</span><a
													title="书法" style="padding-left: 0px;"
													href="search_resources?m=62">书法</a></li>
												<li class="category" <c:if test="${m==63}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[30]}</span><a
													title="音乐" style="padding-left: 0px;"
													href="search_resources?m=63">音乐</a></li>
												<li class="category" <c:if test="${m==64}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[31]}</span><a
													title="舞蹈" style="padding-left: 0px;"
													href="search_resources?m=64">舞蹈</a></li>
												<li class="category" <c:if test="${m==65}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[32]}</span><a
													title="戏剧" style="padding-left: 0px;"
													href="search_resources?m=65">戏剧</a></li>
												<li class="category" <c:if test="${m==66}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[33]}</span><a
													title="建筑" style="padding-left: 0px;"
													href="search_resources?m=66">建筑</a></li>
												<li class="category" <c:if test="${m==67}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[34]}</span><a
								...
								<div id="w1airkp8ag"
									...
									<div class="KB_facetlist collapsed">
										...
										<div class="KB_facetlist_content">
											<ul>
												<li class="category" <c:if test="${m==71}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[35]}</span><a
													title="田径" style="padding-left: 0px;"
													href="search_resources?m=71">田径</a></li>
												<li class="category" <c:if test="${m==72}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[36]}</span><a
													title="球类" style="padding-left: 0px;"
													href="search_resources?m=72">球类</a></li>
												<li class="category" <c:if test="${m==73}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[37]}</span><a
													title="体操" style="padding-left: 0px;"
													href="search_resources?m=73">体操</a></li>
												<li class="category" <c:if test="${m==74}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[38]}</span><a
													title="棋牌" style="padding-left: 0px;"
													href="search_resources?m=74">棋牌</a></li>
												<li class="category" <c:if test="${m==75}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[39]}</span><a
													title="武术" style="padding-left: 0px;"
													href="search_resources?m=75">武术</a></li>
												<li class="category" <c:if test="${m==76}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[40]}</span><a
													title="户外" style="padding-left: 0px;"
													href="search_resources?m=76">户外</a></li>
												<li class="category" <c:if test="${m==77}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[41]}</span><a
								...
								<div id="w1airkp8ah"
									...
									<div class="KB_facetlist collapsed">
										...
										<div class="KB_facetlist_content">
											<ul>
												<li class="category" <c:if test="${m==81}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[42]}</span><a
													title="政治" style="padding-left: 0px;"
													href="search_resources?m=81">政治</a></li>
												<li class="category" <c:if test="${m==82}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[43]}</span><a
								...
								<div id="w1airkp8ai"
									...
									<div class="KB_facetlist collapsed">
										...
										<div class="KB_facetlist_content">
											<ul>
												<li class="category" <c:if test="${m==91}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[44]}</span><a
													title="经融" style="padding-left: 0px;"
													href="search_resources?m=91">经融</a></li>
												<li class="category" <c:if test="${m==92}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[45]}</span><a
													title="管理" style="padding-left: 0px;"
													href="search_resources?m=92">管理</a></li>
												<li class="category" <c:if test="${m==93}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[46]}</span><a
													title="投资" style="padding-left: 0px;"
													href="search_resources?m=93">投资</a></li>
												<li class="category" <c:if test="${m==94}">style="background-color: #e6e6e6"</c:if>><span class="count">${count[47]}</span><a
						...
						<td id="KB_search_right" colspan="1" rowspan="1" class="cell"
							...
							<div class="row-wrapper">
								...
								<div class="csdn-pagination hide-set page1">
									...
									<a href="${pageContext.request.contextPath }/paging_resourcesofcenter?n=1&totalnum=${page.totalNum }" data-page="1" class="btn btn-xs btn-default">首页</a>
									<a href="${pageContext.request.contextPath }/paging_resourcesofcenter?n=${page.pageNO-1 }&totalnum=${page.totalNum }" data-page="1" class="btn btn-xs btn-default">&lt;</a> 
								<c:forEach var="t" begin="${page.startPage }" end="${page.endPage }">	
									<c:if test="${t == page.pageNO }">
										<a href="${pageContext.request.contextPath }/paging_resourcesofcenter?n=${t}&totalnum=${page.totalNum }" data-page="1" class="btn btn-xs btn-default active cblue">${t }</a>
									</c:if>
									<c:if test="${t != page.pageNO }">
										<a href="${pageContext.request.contextPath }/paging_resourcesofcenter?n=${t}&totalnum=${page.totalNum }" data-page="1" class="btn btn-xs btn-default cblue">${t }</a>
									</c:if>
								</c:forEach> 
						
						
									<a href="${pageContext.request.contextPath }/paging_resourcesofcenter?n=${page.pageNO+1 }&totalnum=${page.totalNum }" data-page="907" class="btn btn-xs btn-default">&gt;</a>
									<a href="${pageContext.request.contextPath }/paging_resourcesofcenter?n=${page.totalPage }&totalnum=${page.totalNum }" data-page="907" class="btn btn-xs btn-default">末页</a>
									</span>
								</div>
							</div>
						</td>
