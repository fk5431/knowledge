...
<body>
	...
	<div style="width: 1340px; margin-top:10px;">
						...
						<div id="KB_searchbar"
							...
							<div class="advancedSearchFormContent"
								...
								<div style="margin-left:180px;">
									<iframe
										src="${pageContext.request.contextPath }/resource/index1.html"
								...
								<div>
									<c:forEach items="${sql }" var="s">
										<p style="margin:0 auto;">
											<a
												href="${pageContext.request.contextPath }/search_save?search=${s.id}">${s.sql }</a>
										<p>
									</c:forEach>
								</div>
							</div>
			...
			<c:forEach var="page" items="${page.userfile }">
				...
				<div class="csdn-pagination hide-set page1">
					<span class="page-nav"> <b>共<i>${page.totalNum }条第${page.pageNO }页</i></b>
						<a href="${pageContext.request.contextPath }/paging_elastic_center?n=1&totle=${page.totalNum}" data-page='1' class="btn btn-xs btn-default">首页</a>
						<a href="${pageContext.request.contextPath }/paging_elastic_center?n=${page.pageNO-1 }&totle=${page.totalNum}" data-page='1' class="btn btn-xs btn-default">&lt</a>
					<c:forEach var="t" begin="${page.startPage }" end="${page.endPage }">	
						<c:if test="${t == page.pageNO }">
							<a href="${pageContext.request.contextPath }/paging_elastic_center?n=${t}&totle=${page.totalNum}" data-page='1' class="btn btn-xs btn-default active cblue">${t }</a>
						</c:if>
						<c:if test="${t != page.pageNO }">
							<a href="${pageContext.request.contextPath }/paging_elastic_center?n=${t}&totle=${page.totalNum}" data-page='1' class="btn btn-xs btn-default  cblue">${t }</a>
						</c:if>
					</c:forEach> 
						<a href="${pageContext.request.contextPath }/paging_elastic_center?n=${page.pageNO+1 }&totle=${page.totalNum}" data-page='1' class="btn btn-xs btn-default">></a>
						<a href="${pageContext.request.contextPath }/paging_elastic_center?n=${page.totalPage }&totle=${page.totalNum}" data-page="907" class="btn btn-xs btn-default">末页</a>
					</span>
				</div>
