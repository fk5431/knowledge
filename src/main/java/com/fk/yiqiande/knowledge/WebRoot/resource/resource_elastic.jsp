						...
						<td id="KB_search_right" colspan="1" rowspan="1" class="cell"
							...
							<div class="row-wrapper">
								...
								<div class="csdn-pagination hide-set page1">
									...
									<a href="${pageContext.request.contextPath }/paging_elastic?n=1&totle=${page.totalNum}" data-page="1" class="btn btn-xs btn-default">首页</a>
									<a href="${pageContext.request.contextPath }/paging_elastic?n=${page.pageNO-1 }&totle=${page.totalNum}" data-page="1" class="btn btn-xs btn-default">&lt;</a> 
								<c:forEach var="t" begin="${page.startPage }" end="${page.endPage }">	
									<c:if test="${t == page.pageNO }">
										<a href="${pageContext.request.contextPath }/paging_elastic?n=${t}&totle=${page.totalNum}" data-page="1" class="btn btn-xs btn-default active cblue">${t }</a>
									</c:if>
									<c:if test="${t != page.pageNO }">
										<a href="${pageContext.request.contextPath }/paging_elastic?n=${t}&totle=${page.totalNum}" data-page="1" class="btn btn-xs btn-default cblue">${t }</a>
									</c:if>
								</c:forEach> 
						
						
									<a href="${pageContext.request.contextPath }/paging_elastic?n=${page.pageNO+1 }&totle=${page.totalNum}" data-page="907" class="btn btn-xs btn-default">&gt;</a>
									<a href="${pageContext.request.contextPath }/paging_elastic?n=${page.totalPage }&totle=${page.totalNum}" data-page="907" class="btn btn-xs btn-default">末页</a>
									</span>
								</div>
							</div>
						</td>
