...
<body>
   ...
   box-shadow:0px 0px 10px #909090;">
			<div class="fzq">
				...
				<ul class="navfzq tab_title">
					...
					<li id="one2" class="off">
						<div class="tab_title">
							<a href="javascript:;" class="cur" style="line-height:3;">历史浏览</a>
						</div>
					</li>
					<li id="one3">
						<div class="tab_title">
			...
			<ul class="list02" id="feed_list">
				<c:forEach var="page" items="${page_center_history.userfile }">
					<li class="clearfix">
				...
				<div class="csdn-pagination hide-set page1">
					<span class="page-nav"> <b>共 <i>${page_center_history.totalNum }条第${page_center_history.pageNO }页</i></b>
						<a href="${pageContext.request.contextPath }/paging_center1?n=1" data-page='1' class="btn btn-xs btn-default">首页</a>
						<a href="${pageContext.request.contextPath }/paging_center1?n=${page_center_history.pageNO-1 }" data-page='1' class="btn btn-xs btn-default">&lt</a>
					<c:forEach var="t" begin="${page_center_history.startPage }" end="${page_center_history.endPage }">	
						<c:if test="${t == page_center_history.pageNO }">
							<a href="${pageContext.request.contextPath }/paging_center?n=${t}" data-page='1' class="btn btn-xs btn-default active cblue">${t }</a>
						</c:if>
						<c:if test="${t != page_center_history.pageNO }">
							<a href="${pageContext.request.contextPath }/paging_center?n=${t}" data-page='1' class="btn btn-xs btn-default  cblue">${t }</a>
						</c:if>
					</c:forEach> 
						<a href="${pageContext.request.contextPath }/paging_center1?n=${page_center_history.pageNO+1 }" data-page='1' class="btn btn-xs btn-default">></a>
						<a href="${pageContext.request.contextPath }/paging_center1?n=${page_center_history.totalPage }" data-page="907" class="btn btn-xs btn-default">末页</a>
					</span>
				</div>
